...
function work(str){
let value = str.split(" ");
let firstCharOfFIrst = value[0][0]; //n
let firstCharOfSecond = value[1][0]; //p
let firstremain = value[0].slice(1); //ot
let Secondremain = value[1].slice(1); //icking


 let newstr = firstCharOfSecond + firstremain+ " "+firstCharOfFIrst+Secondremain;
 console.log(newstr)
}
